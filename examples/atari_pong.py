...
def create_parameter(env, nb_steps):
    ...
    kwargs = {
        ...
        "optimizer_ext": Adam(learning_rate=0.0001, epsilon=0.0001),
        "optimizer_int": Adam(learning_rate=0.0001, epsilon=0.0001),
        "optimizer_rnd": Adam(learning_rate=0.0005, epsilon=0.0001),
        "optimizer_emb": Adam(learning_rate=0.0005, epsilon=0.0001),
        ...
        # train
        "memory_warmup_size": 620,    # 初期のメモリー確保用step数(学習しない)
