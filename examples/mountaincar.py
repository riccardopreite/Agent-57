...
def create_parameter(env, nb_steps):
    ...
    kwargs = {
        ...
        "optimizer_ext": Adam(learning_rate=0.001),
        "optimizer_int": Adam(learning_rate=0.001),
        "optimizer_rnd": Adam(learning_rate=0.005),
        "optimizer_emb": Adam(learning_rate=0.005),

        # NN
        "input_sequence": 4,         # 入力フレーム数
        "dense_units_num": 128,       # dense層のユニット数
